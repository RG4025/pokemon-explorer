                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid grid-cols-1  gap-8">
                        <div className="space-y-6">
                            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 border border-white/20 dark:border-gray-700/20">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600 dark:text-gray-300">Kolhapur, Maharashtra, India</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 border border-white/20 dark:border-gray-700/20">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <a
                                        ...
                                        className="flex items-center space-x-3 p-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-lg text-white transition-all duration-200 transform hover:scale-105"
                                    >
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex items-center space-x-3 p-4 bg-gradient-to-r from-gray-800 to-gray-900 hover:from-gray-900 hover:to-black rounded-lg text-white transition-all duration-200 transform hover:scale-105"
                                    >
                                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
